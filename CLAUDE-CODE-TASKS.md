...
> **עודכן 2026-08-28: הקוד כתוב, מקומפל, ולא צרוב.**
>
...
>
> **מה שנשאר: צריבה ואימות על חומרה.** הלוח מריץ 0.11.1 מ-2026-08-04.
> הבינרי המוכן הוא `C:\tmp\h2_coordinator_flash` (2026-08-23 20:11), והמקור
> שממנו נבנה זהה ל-`zb.c` הנוכחי. הדרך חזרה: `C:\tmp\h2_v0110`.
> **החסם היחיד הוא פיזי** — ל-H2 אין USB מחובר; הוא מדבר עם הפאנל ב-UART,
> ו-`flash_h2_coordinator.ps1` מצפה ל-COM6.
