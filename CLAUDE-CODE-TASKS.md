...
> ## מצב — עודכן 2026-08-20, ענף `fix/review-2026-08` (31 קומיטים, נדחף)
>
> **הסוויטה: 454 עוברים, 1 מדולג, 1,500 subtests.**
...
>
> **11–13, 15, 17** (`zigbee_gateway`) · **16** (`api`/`views`) · **18–22**
> (קושחת H2) · **23** (hub/web/tools) · **24** (`control_service`)
>
