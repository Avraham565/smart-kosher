param(
    [string]$BuildRoot = "",
    [string]$FlashOut  = "C:\tmp\h2_coordinator_flash"
)
...
if ([string]::IsNullOrWhiteSpace($BuildRoot)) {
    ...
    $BuildRoot = "C:\tmp\zigbee_coord_h2_build_$stamp"
...
$wslCommand = "source ~/esp/esp-idf/export.sh && cd $wslBuild && idf.py set-target esp32h2 && idf.py build"
...
Write-Host "H2 coordinator build complete."
